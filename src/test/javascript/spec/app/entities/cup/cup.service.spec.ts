...
import { ICup, Cup, CupStatus } from 'app/shared/model/cup.model';
...
describe('Service Tests', () => {
    describe('Cup Service', () => {
        ...
        let elemDefault: ICup;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(CupService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Cup(0, 'AAAAAAA', CupStatus.InStore);
        });
