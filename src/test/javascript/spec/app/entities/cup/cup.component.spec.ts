...
import { CupComponent } from 'app/entities/cup/cup.component';
...
describe('Component Tests', () => {
    describe('Cup Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
