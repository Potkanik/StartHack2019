...
import ch.start.hack.security.SecurityUtils;
import ch.start.hack.service.MailService;
import ch.start.hack.service.UserService;
import ch.start.hack.service.dto.PasswordChangeDTO;
import ch.start.hack.service.dto.UserDTO;
import ch.start.hack.web.rest.errors.*;
import ch.start.hack.web.rest.vm.KeyAndPasswordVM;
